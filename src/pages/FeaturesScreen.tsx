...
const icons: Record<RealtimeFeature, React.ReactNode> = {
  voiceChat: (
  ...
  brainstorming: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 1 1 7.072 0l-.548.547A3.374 3.374 0 0 0 12 18.469a3.374 3.374 0 0 0-.916-1.46l-.548-.547z" />
    </svg>
  ),
};
  ...
  return (
    <div className="features-screen">
      ...
      <div className="features-content kiosk-container">
        <h1 className="features-title">Realtime GPT</h1>
